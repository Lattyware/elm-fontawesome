...
{-| The [`firefox-browser`](https://fontawesome.com/icons/firefox-browser?style=brands) icon.
-}
firefoxBrowser : Icon
firefoxBrowser =
    Icon
...
{-| The [`ideal`](https://fontawesome.com/icons/ideal?style=brands) icon.
-}
ideal : Icon
ideal =
    Icon
...
{-| The [`microblog`](https://fontawesome.com/icons/microblog?style=brands) icon.
-}
microblog : Icon
microblog =
    Icon
...
{-| The [`pied-piper-square`](https://fontawesome.com/icons/pied-piper-square?style=brands) icon.
-}
...
{-| The [`unity`](https://fontawesome.com/icons/unity?style=brands) icon.
-}
unity : Icon
unity =
    Icon
