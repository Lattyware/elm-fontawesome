...
module FontAwesome.Attributes exposing (fa2xs, xs, sm, lg, x1, fa2x1, fa1x, fa2x, fa3x, fa4x, fa5x, fa6x, fa7x, fa8x, fa9x, fa10x, fw, ul, li, rotate90, rotate180, rotate270, flipHorizontal, flipVertical, flipBoth, flipRotateBy, beat, fade, beatFade, bounce, flip, shake, spin, spinPulse, spinReverse, pullLeft, pullRight, border, stack, stack1x, stack2x, inverse, swapOpacity)
